...
return s.replace((new RegExp((function (){var G__24587 = match;
return goog.string.regExpEscape(G__24587);
})(),"g")),replacement);
} else {
...
while(true){
if(coll__$1){
var G__24588 = sb.append([cljs.core.str(cljs.core.first(coll__$1))].join(''));
var G__24589 = cljs.core.next(coll__$1);
sb = G__24588;
coll__$1 = G__24589;
continue;
} else {
...
var G__24592 = cljs.core.pop(v__$1);
v__$1 = G__24592;
continue;
} else {
return v__$1;
...
var pred__24600 = cljs.core._EQ_;
var expr__24601 = limit;
if(cljs.core.truth_((function (){var G__24603 = (1);
...
if(cljs.core.truth_((function (){var G__24605 = (2);
var G__24606 = expr__24601;
return (pred__24600.cljs$core$IFn$_invoke$arity$2 ? pred__24600.cljs$core$IFn$_invoke$arity$2(G__24605,G__24606) : pred__24600.call(null,G__24605,G__24606));
})())){
...
var G__24610 = s__$1.substring((index + cljs.core.count(m)));
var G__24611 = (limit__$1 - (1));
var G__24612 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__24610;
limit__$1 = G__24611;
parts = G__24612;
continue;
...
var G__24614 = s;
return goog.string.trim(G__24614);
});
/**
...
var G__24616 = s;
return goog.string.trimLeft(G__24616);
});
/**
...
var G__24618 = s;
return goog.string.trimRight(G__24618);
});
/**
...
var G__24621 = s;
return goog.string.isEmptySafe(G__24621);
});
/**
...
var temp__4124__auto___24622 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);
if(cljs.core.truth_(temp__4124__auto___24622)){
var replacement_24623 = temp__4124__auto___24622;
buffer.append([cljs.core.str(replacement_24623)].join(''));
} else {
buffer.append(ch);
}

var G__24624 = (index + (1));
index = G__24624;
continue;
}
break;
